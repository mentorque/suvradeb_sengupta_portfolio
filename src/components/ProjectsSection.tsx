  ...
  const projects: Project[] = [
    {
      ...
      highlights: [
        "Contributed to a comprehensive Project Management Plan for a government-commissioned bilingual mobile app connecting tourists to Irish history and culture in English and Irish.",
        "Covered a €1M budget, 34-week delivery schedule, risk register, and RACI stakeholder matrix across 15 stakeholders.",
        "Authored Closure and Maintenance sections — incident SLAs, quality gates (GDPR, WCAG, ISO 27001), and 90% user satisfaction acceptance threshold.",
      ],
      stack: ["Project Management", "Agile", "Risk Management", "GDPR", "WCAG", "ISO 27001"],
    ...
    },
    {
      ...
      highlights: [
        "Built a full-stack event management application from scratch using Java, Spring Boot, Hibernate, MySQL, and JSP.",
        "Automated participant registration, role-based access control, and real-time data logging for 200+ users.",
        "Replaced manual, error-prone event workflows with a single reliable system for managers to track and scale events.",
      ],
      stack: ["Java", "Spring Boot", "Hibernate", "MySQL", "JSP", "REST APIs"],
